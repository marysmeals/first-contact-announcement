...
We've joined the coordinated European effort called [Pan-European Privacy-Preserving Proximity Tracing (PEPP-PT)](https://www.pepp-pt.org/) and will be using their core library to implement a compatible application for Romania, which could be later translated or adapted to other countries.
